...
import { memoryJsonStdMarkData } from '../../wasm/memoryData'
import SpeedTest from "../GaugePointer";
import { getJsonAttended, getJsonFulleMark, getQueryJsonData } from "../../API/API";


function JsonApiReport(props) {
    ...
    const handleGenerateChart = async () => {
        ...
        const dataFm = await getJsonFulleMark()
        console.log("in report&&"+JSON.stringify(dataFm));
        
        const dataAt = await getJsonAttended()
